...
public class BuskingDAO {
	...
	}public List resBusking(HashMap hashMap) {
		return sqlSession.selectList("mapper.busking.resBusking", hashMap);
	}public List allBusking(HashMap hashMap) {
		return sqlSession.selectList("mapper.busking.allBusking", hashMap);
	}
}
